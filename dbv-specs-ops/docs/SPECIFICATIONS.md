...
5. **Criterios de aceptación:** existe un informe con las cifras anteriores medidas (no estimadas), un resumen de casos en que el respaldo se activó y una **recomendación razonada**, y el usuario elige entre (a)–(c) tras leerlo.
