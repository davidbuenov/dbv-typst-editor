// =============================================================================
// Plantilla TFM de DBV Typst Editor — definición de estilo
...
//
// Estructura idéntica a la plantilla de TFG a propósito: en la inmensa
// mayoría de universidades españolas el formato de TFG y TFM es el mismo
// documento normativo, solo cambia la etiqueta "Grado"/"Máster".
...
#let tfm(
  ...
  page(numbering: none, header: none, footer: none)[
    ...
    #line(length: 60%, stroke: 0.6pt)
    #v(1.2cm)
    #text(size: 12pt, style: "italic")[Trabajo de Fin de Máster]
    #v(1fr)
    #grid(
      columns: (1fr, 1fr),
      align: (left, right),
