...
const DICTIONARIES = {
  es: {
    ...
    'action.outline': 'Esquema del documento',
    ...
    'mode.edicion': 'Modo Edición — editor y todas las herramientas',
    'mode.escritura': 'Modo Escritura — solo el editor, sin herramientas',
    'mode.dividido': 'Modo Dividido — editor y vista previa',
    'mode.lectura': 'Modo Lectura — solo la vista previa, a pantalla completa',
  ...
  en: {
    ...
    'action.outline': 'Document outline',
    ...
    'mode.edicion': 'Editing mode — editor and all tools',
    'mode.escritura': 'Writing mode — editor only, no tools',
    'mode.dividido': 'Split mode — editor and preview',
    'mode.lectura': 'Reading mode — preview only, full screen',
